...
lista_original_revisores = [
    "andrea.ampai@iie.cl","antonia.rios@iie.cl","claudia.sanjuan@iie.cl",
    "daniela.jara@iie.cl","daniela.medel@iie.cl","daniela.sanhueza@iie.cl",
    "gabriela.forte@iie.cl","javiera.arriagada@iie.cl","katherine.marilaf@iie.cl",
    "leslie.segura@iie.cl","maria.salinas@iie.cl","mariela.arevalo@iie.cl",
    "natalia.espinoza@iie.cl","pamela.alarcon@iie.cl","pedro.salinas@iie.cl",
...
if uploaded_file is not None:
    try:
        ...
        pendientes_sin_revisor = df[(df["revisor"].isna()) & (df["estado_nombre"]=="pendiente_de_revision")]
